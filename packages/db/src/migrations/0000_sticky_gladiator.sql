...
CREATE TYPE "public"."availability_status" AS ENUM('available', 'busy', 'blocked');--> statement-breakpoint
...
CREATE TYPE "public"."user_role" AS ENUM('admin', 'doctor', 'patient', 'receptionist');--> statement-breakpoint
